...
public class DefaultConnectionSupplierImpl implements ConnectionSupplier {
	...
	public DefaultConnectionSupplierImpl(final Connection connection) {
		this.connection = new NoCloseConnectionWrapper(connection);
	}
	 ...
	 */
	private class NoCloseConnectionWrapper implements Connection {
		private final Connection original;

		public NoCloseConnectionWrapper(Connection original) {
