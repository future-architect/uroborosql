...
public class SecretColumnEventSubscriberTest extends BaseEventSubscriberTest {
	...
	public void setUp() throws Exception {
		...
		subscriber
				.setKeyStoreFilePath("src/test/resources/data/expected/SecretColumnEvent/keystore.jceks");
		...
		config = UroboroSQL.builder(DriverManager.getConnection("jdbc:h2:mem:SecretColumnEventSubscriberTest"))
	...
	public void testSubscriberSettings() {
		...
		assertThat(subscriber.getTransformationType(), is("AES/ECB/PKCS5Padding"));
