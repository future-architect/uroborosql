...
public class SqlContextImplTest {
	...
	public void removeFirstAndKeyWordWhenWhereClause() throws Exception {
		...
		assertEquals(replaceLineSep("select * from test where -- /* comment */  [LF] order = 1"), ctx5.getExecutableSql());
	...
	public void removeFirstCommaWhenSelectClause() throws Exception {
		...
		assertEquals(replaceLineSep("select /* comment */ [LF] aaa[LF], bbb[LF], ccc from test"), ctx4.getExecutableSql());

		SqlContext ctx5 = getSqlContext("select -- /* comment */ [LF], aaa[LF], bbb[LF], ccc from test");
		assertEquals(replaceLineSep("select -- /* comment */ [LF] aaa[LF], bbb[LF], ccc from test"), ctx5.getExecutableSql());
	}
	...
	public void removeFirstCommaWhenOrderByClause() throws Exception {
		...
		assertEquals(replaceLineSep("select * from test order by --/* comment */[LF] aaa, bbb"), ctx5.getExecutableSql());
	}
	...
	public void removeFirstCommaWhenGroupByClause() throws Exception {
		...
		assertEquals(replaceLineSep("select * from test group by /* comment */  [LF] aaa, bbb"), ctx4.getExecutableSql());

		SqlContext ctx5 = getSqlContext( "select * from test group by /* comment */ --aaa[LF], aaa, bbb");
		assertEquals(replaceLineSep("select * from test group by /* comment */ --aaa[LF] aaa, bbb"), ctx5.getExecutableSql());
	}
	...
	public void removeFirstCommaWhenStartBracket() throws Exception {
		...
		assertEquals(replaceLineSep("insert into ([LF]/* comment */ aaa[LF], bbb[LF], ccc[LF]) values (/* comment */[LF]111,[LF]222,[LF]333[LF])"), ctx4.getExecutableSql());

		SqlContext ctx5= getSqlContext( "insert into (--comment[LF], aaa[LF], bbb[LF], ccc[LF]) values (,/*comment*/[LF]111,[LF]222,[LF]333[LF])");
		assertEquals(replaceLineSep("insert into (--comment[LF] aaa[LF], bbb[LF], ccc[LF]) values (/*comment*/[LF]111,[LF]222,[LF]333[LF])"), ctx5.getExecutableSql());
	}
	...
	public void removeFirstCommaWhenSetClause() throws Exception {
		...
		assertEquals(replaceLineSep("update test set aaa = 111, bbb = 222, ccc = 333 where 1 = 1"), ctx1.getExecutableSql());

		SqlContext ctx2 = getSqlContext("update test set , aaa = 111, bbb = 222, ccc = 333 where 1 = 1");
		assertEquals(replaceLineSep("update test set  aaa = 111, bbb = 222, ccc = 333 where 1 = 1"), ctx2.getExecutableSql());
		...
		assertEquals(replaceLineSep("update test set /* comment */[LF]aaa = 111, bbb = 222, ccc = 333 where 1 = 1"), ctx4.getExecutableSql());

		SqlContext ctx5 = getSqlContext("update test set --comment[LF],aaa = 111, bbb = 222, ccc = 333 where 1 = 1");
		assertEquals(replaceLineSep("update test set --comment[LF]aaa = 111, bbb = 222, ccc = 333 where 1 = 1"), ctx5.getExecutableSql());
	}
}