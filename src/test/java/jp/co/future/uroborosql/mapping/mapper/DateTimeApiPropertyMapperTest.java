...
public class DateTimeApiPropertyMapperTest {
	...
	@Test
	public void testJavaTime() throws NoSuchMethodException, SecurityException, SQLException {
		Clock clock = Clock.systemDefaultZone();
		PropertyMapperManager mapper = new PropertyMapperManager(clock);
		LocalDateTime localDateTime = LocalDateTime.now();
		OffsetDateTime offsetDateTime = OffsetDateTime.of(localDateTime, OffsetDateTime.now().getOffset());
		ZonedDateTime zonedDateTime = ZonedDateTime.of(localDateTime, clock.getZone());

		java.sql.Timestamp timestamp = java.sql.Timestamp.valueOf(localDateTime);
		LocalDate localDate = localDateTime.toLocalDate();
		java.sql.Date date = java.sql.Date.valueOf(localDate);
		LocalTime localTime = localDateTime.toLocalTime();
		java.sql.Time time = new java.sql.Time(toTime(localTime, clock));
	...
	@Test
	public void testJavaTimeWithTimeZone() throws NoSuchMethodException, SecurityException, SQLException {
		Clock clock = Clock.system(ZoneId.of("Asia/Shanghai"));
		PropertyMapperManager mapper = new PropertyMapperManager(clock);
		LocalDateTime localDateTime = LocalDateTime.now(clock);
		OffsetDateTime offsetDateTime = OffsetDateTime.of(localDateTime, OffsetDateTime.now(clock).getOffset());
		ZonedDateTime zonedDateTime = ZonedDateTime.of(localDateTime, clock.getZone());
	...
	@Test
	public void testYmd() throws NoSuchMethodException, SecurityException, SQLException {
	...
	@Test
	public void testEra() throws NoSuchMethodException, SecurityException, SQLException {
		PropertyMapperManager mapper = new PropertyMapperManager(Clock.systemDefaultZone());
	...
	private long toTime(final TemporalAccessor temporalAccessor, final Clock clock) {
